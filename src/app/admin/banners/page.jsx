        ...
        <tbody>
          {banners.map((b, i) => (
            <tr key={b._id} className="hover:bg-gray-50">
              ...
              <td className="p-2 border text-center">{b.thumb ? <img src={b.thumb} className="h-12 w-20 object-cover mx-auto" /> : <ImageIcon className="h-8 w-8 text-gray-400 mx-auto" />}</td>
