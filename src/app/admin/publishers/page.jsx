        ...
        <tbody>
          {publishers.map((p, i) => (
            <tr key={p._id} className="hover:bg-gray-50">
              ...
              <td className="p-2 border text-center">{p.image ? <img src={p.image} className="h-10 w-10 object-contain mx-auto" alt={Array.isArray(p.name) ? p.name[1] || "Publisher" : p.name || "Publisher"} /> : <BookOpen className="h-8 w-8 text-gray-400 mx-auto" />}</td>
